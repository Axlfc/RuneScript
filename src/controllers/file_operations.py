...
from src.controllers.menu_creators import create_python_menu, create_csv_menu, create_generic_text_menu, create_markdown_menu, create_javascript_menu, create_html_menu, create_css_menu, create_java_menu, create_cpp_menu, create_latex_menu, create_bash_menu, create_powershell_menu
...
file_types = [('All Files', '*.*'), ('Python Scripts', '*.py'), ('Shell Scripts', '*.sh'), ('PowerShell Scripts', '*.ps1'), ('Text Files', '*.txt'), ('LaTeX Files', '*.tex'), ('CSV Files', '*.csv'), ('JavaScript Files', '*.js'), ('HTML Files', '*.html'), ('CSS Files', '*.css'), ('Java Files', '*.java'), ('C++ Files', '*.cpp'), ('Ruby Scripts', '*.rb'), ('Perl Scripts', '*.pl'), ('PHP Scripts', '*.php'), ('Python Notebooks', '*.ipynb'), ('Swift Scripts', '*.swift'), ('Go Files', '*.go'), ('R Scripts', '*.r'), ('Rust Files', '*.rs'), ('Dart Files', '*.dart')]
...
def open_script():
    ...
    if is_modified:
        response = messagebox.askyesnocancel(localization_data['save_changes'], localization_data['save_confirmation'])
        if response:
            if not save():
                return
...
def update_menu_based_on_extension(ext):
    menu_creators = {'.py': create_python_menu, '.csv': create_csv_menu, '.txt': create_generic_text_menu, '.md': create_markdown_menu, '.js': create_javascript_menu, '.html': create_html_menu, '.css': create_css_menu, '.java': create_java_menu, '.cpp': create_cpp_menu, '.tex': create_latex_menu, '.sh': create_bash_menu, '.ps1': create_powershell_menu}
    file_type_labels = {'.py': 'Python', '.csv': 'CSV', '.txt': 'Text', '.md': 'Markdown', '.js': 'Javascript', '.html': 'HTML', '.css': 'CSS', '.java': 'Java', '.cpp': 'C++', '.tex': 'LaTeX', '.sh': 'Bash', '.ps1': 'PowerShell'}
